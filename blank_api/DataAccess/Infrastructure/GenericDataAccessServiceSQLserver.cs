...
namespace DataAccess.Infrastructure
{
    ...
    public class GenericDataAccessServiceSQLserver
...

    {
        ...
        private static GenericDataAccessServiceSQLserver instance;

        public new static GenericDataAccessServiceSQLserver Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new GenericDataAccessServiceSQLserver();
                }
                return instance;
            }
        }
